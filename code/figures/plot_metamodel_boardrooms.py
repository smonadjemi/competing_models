...
data_path = './outputs/boardrooms_metamodel_1/1_16.json'

#data_path = 'outputs/crime_open_ended_1/open-ended_q_2.json'
...
plt.title('Posterior Belief over Models')
...
plt.savefig('figures/%s_%d.png' % ('mp', int(random.random()*1000)))
